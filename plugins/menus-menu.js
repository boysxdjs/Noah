...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  try {
    ...
    const str = `🇪🇬 𝐁𝐥𝐨𝐝𝐢𝐞 𝐁𝐨𝐭 🇪🇬

  *Ey , Hola ${taguser} Te Presento Este Bot 🇪🇬️*

┏━━═════⊰⊱ ⬛ ⊰⊱═════━━┓
 ►🇪🇬️ Creador : Blodie
 ►🇪🇬️ Numero ; +54 9 11 5963-4868
 ►🇪🇬️ Adquirir : +51 936 994 155
 ►🇪🇬️ Ig : https://www.instagram.com/x27_Raiders_2023/
 ►🇪🇬️ BlodieCoins ${money}
 ${readMore}
┣━━═════⊰⊱ ⬛ ⊰⊱═════━━┛
...
┏━━═════⊰⊱ ⬛ ⊰⊱═════━━┓
 ...
 ►🇪🇬️ _${usedPrefix}AlacranSpeed_
 ►🇪🇬️ _${usedPrefix}donar_
 ►🇪🇬️ _${usedPrefix}owner_
 ►🇪🇬️ _${usedPrefix}reporte *<txt>*_
 ►🇪🇬️ _${usedPrefix}join *<wagp_url>*_
